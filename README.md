...
You can add symbol keys to register windows. (Only the [Japanese keyboard symbols](https://github.com/oniatsu/HotSwitch-HS/blob/main/lib/common/KeyConstants.lua#L30) are available now.)
